...
<body class="bg-[#111827] scroll-smooth">
    <x-app-layout>
        <div class="pt-10 pl-10 flex w-full justify-between">
            <p class="text-white text-4xl"> Create your Note</p>
            <a href="{{route('note-index')}}">
                <button
                    class="py-1 mr-16 group hover:bg-green-600 hover:border-green-600 text-gray-500/60 text-[18px] font-semibold hover:text-white transition-all flex px-12 rounded-md border-2 border-gray-700 ">
                    <?xml version="1.0" encoding="utf-8"?><svg fill="rgb(107 114 128 / 0.6)" class=" group-hover:fill-white transition-all" width="20" height="20"
        ...
        <form action="{{route('note-store')}}" method="post">
            @csrf
            <div id="step-1">
                <div class="flex items-center p-12 flex-wrap">
                    <div>
                    ...
                    <div class="ml-16">
                        ...
                        <div>
                            ...
                            @error('category_id')
                            <p class="pt-1 border-b-2 border-b-red-500/50 text-red-600"> {{$message}} </p>
                            @enderror
                        </div>
                    </div>
                </div>
                <div class="w-full items-center flex justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="440.83373" height="440.5"
                        ...
                        <path
                            ...
                            transform="translate(-357.08314 -208.25)" fill="#6c63ff" />
                        <path
                        ...
                        <path d="M498.08314,691.75h-140a1,1,0,1,1,0-2h140a1,1,0,0,1,0,2Z"
                            transform="translate(-357.08314 -208.25)" fill="#ccc" /></svg>
                </div>
                <div class="w-full items-center flex justify-center mt-20">
                    <button class="bg-purple-700 py-3 px-28 rounded-md hover:bg-purple-600  transition-all"
                        id="next-step" type="button"> Next step!
                    </button>
                </div>
            </div>

            <!------ ----------Form part 2----------------->
            <div class=" mx-auto w-[800px] h-3/4 rounded-lg border border-gray-700 p-8 lg:py-12 lg:px-14 text-gray-300 mt-16 hidden"
                id="step-2">
                <div class="mb-10">
                    ...
                    @error('content')
                    <p class="ml-2 border-b-2 border-b-red-500/50 text-red-600"> {{$message}} </p>
                    @enderror
                </div>
                <div class="flex justify-center flex-col items-center">
                    ...
                    <div class="flex gap-16 mt-5">
                        <button type="button" id="back-step"
                            class="py-3 px-10 border border-gray-700 text-gray-500/60 transition-all rounded leading-none focus:outline-none text-sm hover:text-white/90 hover:border-purple-600 hover:bg-purple-700/70"> volver atrás</button>
                        <button type="submit"
